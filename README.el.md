...
- **Βελτιωμένες συνδέσεις** — Πολυκατευθυντικές συνδέσεις, ομάδες συνδέσεων, έξυπνες προτάσεις
...
- **Προσαρμοσμένα AI μοντέλα** — Χρησιμοποιήστε τα δικά σας OpenAI/Anthropic API κλειδιά
- **Καρτέλες τερματικού** — Πολλαπλές τερματικές συνεδρίες ανά worktree
- **Οπτικοποίηση γραφήματος Git** — Οπτικό ιστορικό branches και merges
- **Profiling απόδοσης** — Ενσωματωμένα εργαλεία βελτιστοποίησης

### 🎯 Μελλοντικό Όραμα

- **Νοημοσύνη συνδέσεων** — AI-powered προτάσεις σύνδεσης βασισμένες στο git ιστορικό
- **Marketplace συνδέσεων** — Μοιραστείτε και ανακαλύψτε πρότυπα σύνδεσης
