...
شغّل وكلاء برمجة بالذكاء الاصطناعي مباشرة داخل Hive مع دعم كل من **OpenCode** و**Claude Code**. تابع الردود في الوقت الفعلي، راقب تنفيذ استدعاءات الأدوات، ووافق على الأذونات حسب الحاجة. دعم كامل للتراجع والإعادة يبقيك متحكماً.
...
افتح worktree → انقر **"جلسة جديدة"** → ابدأ البرمجة مع OpenCode أو Claude
...
- **اتصالات محسّنة** — اتصالات متعددة الاتجاهات، مجموعات اتصالات، اقتراحات ذكية
- **مزامنة سحابية** — مزامنة الإعدادات والجلسات وقوالب الاتصال عبر الأجهزة
- **ميزات الفريق** — شارك أشجار العمل وتعاون في الوقت الفعلي
- **نماذج AI مخصصة** — استخدم مفاتيح OpenAI/Anthropic API الخاصة بك
- **تبويبات الطرفية** — عدة جلسات طرفية لكل worktree
- **تصور مخطط Git** — تاريخ الفروع والدمج بصرياً
- **ملفات تعريف الأداء** — أدوات مدمجة للتحسين

### 🎯 الرؤية المستقبلية

- **ذكاء الاتصالات** — اقتراحات اتصال مدعومة بالذكاء الاصطناعي بناءً على تاريخ git
- **سوق الاتصالات** — شارك واكتشف قوالب الاتصال
...
│   └── services/          # خدمات Git، OpenCode، السجل، الملفات
...
| الذكاء الاصطناعي        | [OpenCode SDK](https://opencode.ai)                                              |
