...
Запускайте ИИ-агентов для кодирования прямо внутри Hive с поддержкой **OpenCode** и **Claude Code**. Стримьте ответы в реальном времени, наблюдайте за вызовами инструментов и одобряйте разрешения по мере необходимости. Полная поддержка отмены/повтора даёт вам контроль.
...
Откройте worktree → Нажмите **«New Session»** → Начните кодировать с OpenCode или Claude
...
- **Улучшенные соединения** — Многосторонние соединения, группы, умные предложения
...
- **Пользовательские ИИ-модели** — Используйте свои ключи API OpenAI/Anthropic
- **Вкладки терминала** — Несколько сессий терминала на worktree
...
- **Интеллект соединений** — ИИ-предложения соединений на основе истории git
- **Маркетплейс соединений** — Делитесь и находите шаблоны соединений
...
│   └── services/          # Git, OpenCode, логгер, файловые сервисы
...
| ИИ        | [OpenCode SDK](https://opencode.ai)                                              |
