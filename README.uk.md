...
- **Покращені з'єднання** — Багатосторонні з'єднання, групи, розумні пропозиції
...
- **Власні AI-моделі** — Використовуйте свої ключі API OpenAI/Anthropic
- **Вкладки терміналу** — Кілька сесій терміналу на worktree
- **Візуалізація графу Git** — Візуальна історія гілок та злиттів
- **Профілювання продуктивності** — Вбудовані інструменти оптимізації

### 🎯 Бачення майбутнього

- **Інтелект з'єднань** — AI-пропозиції з'єднань на основі історії git
- **Маркетплейс з'єднань** — Діліться та знаходьте шаблони з'єднань
