...
- **מודלי AI מותאמים** — הביאו את מפתחות ה-API של OpenAI/Anthropic שלכם
- **טאבי טרמינל** — מספר סשני טרמינל לכל worktree
- **ויזואליזציית גרף Git** — היסטוריית ענפים ומיזוגים ויזואלית
- **פרופיילינג ביצועים** — כלים מובנים לאופטימיזציה

### 🎯 חזון עתידי

- **אינטליגנציית חיבורים** — הצעות חיבור מונעות AI בהתבסס על היסטוריית git
- **שוק חיבורים** — שתפו וגלו תבניות חיבור
